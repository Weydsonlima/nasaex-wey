...
const formSchema = z.object({
  userIds: z.array(z.string()).min(1, "Selecione ao menos um responsável"),
});

export type SetResponsibleFormValues = z.infer<typeof formSchema>;

interface Props {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (values: SetResponsibleFormValues) => void;
  defaultValues?: Partial<SetResponsibleFormValues>;
}
...
export const SetResponsibleDialog = ({
  open,
  onOpenChange,
  onSubmit,
  defaultValues,
  ...
  const form = useForm<SetResponsibleFormValues>({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Definir responsáveis</DialogTitle>
          <DialogDescription>
            Atribua um ou mais responsáveis para esta ação.
          </DialogDescription>
        </DialogHeader>
