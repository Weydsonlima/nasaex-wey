...
export function AccessPanel() {
  ...
  async function handleGrant(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success(
        `PIN gerado e enviado via ${sendVia === "email" ? "e-mail" : "WhatsApp"}!`,
      );
      setShowDialog(false);
      setUserId("");
      setPhone("");
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-muted-foreground leading-relaxed">
        Apenas usuários autorizados abaixo podem acessar o módulo financeiro. O
        PIN é gerado aleatoriamente e enviado por e-mail ou WhatsApp. Nenhuma
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem
                          ...
                          onClick={() =>
                            handleRegenerate(r.userId, "email", null)
                          }
                        >
                        ...
                        {r.phone && (
                          <DropdownMenuItem
                            className="gap-2 text-xs"
                            onClick={() =>
                              handleRegenerate(r.userId, "whatsapp", r.phone)
                            }
                          >
        ...
        <DialogContent className="max-w-sm">
          ...
          <form onSubmit={handleGrant} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={sendVia}
                onValueChange={(v) => setSendVia(v as "email" | "whatsapp")}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
